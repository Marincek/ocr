    ...
    private class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                imageFilePath = MediaStore.Images.Media.insertImage(getActivity().getContentResolver(), file.getAbsolutePath(), file.getName(), file.getName());
